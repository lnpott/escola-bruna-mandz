...
# ETAPA 33 — MÓDULO FINANCEIRO (PLANEJAMENTO)

## Objetivo

Iniciar o desenvolvimento do módulo **Financeiro** do Painel Administrativo da Escola Bruna Mandz, seguindo a mesma filosofia adotada em todo o projeto:

* Interface simples.
* Poucos cliques.
* Fácil utilização pela secretaria.
* Informações objetivas.
* Banco preparado para futuras expansões.

Nesta etapa **não haverá integração com Mercado Pago**, boletos ou qualquer automação bancária. O foco é criar uma base sólida para controle financeiro interno.

---

# Filosofia

O módulo Financeiro não será um sistema de contabilidade.

Seu objetivo é responder rapidamente perguntas do dia a dia da secretaria, como:
...
Todo o desenvolvimento será guiado por essas necessidades.

---

# Estrutura do Painel

Será criado um novo módulo dentro do Painel Administrativo.
...
# Estrutura Inicial do Financeiro

O módulo será dividido nas seguintes áreas:
...
Tela principal de controle financeiro.
...
## Cadastro Financeiro do Aluno

Cada aluno possuirá uma configuração financeira independente.
...
O cadastro financeiro ficará vinculado ao cadastro do aluno.

---

## Recebimentos

Controle manual dos pagamentos recebidos.
...
Todo pagamento fará parte do histórico permanente do aluno.

---

## Despesas

Cadastro simples das despesas da escola.
...
O sistema consolidará automaticamente:
...
Serão criadas inicialmente quatro tabelas.
...
Histórico completo das mensalidades.
...
* Fluxo de caixa
* Linha do tempo financeira do aluno
* Exportação CSV
* Relatórios simples
...
Nesta etapa não serão implementados:
...
Essas funcionalidades poderão ser avaliadas futuramente conforme a necessidade operacional da escola.
...
2. Menu Financeiro.
3. Dashboard.
4. Cadastro financeiro do aluno.
5. Controle de mensalidades.
...
O módulo Financeiro será desenvolvido utilizando a mesma arquitetura dos demais módulos do sistema, mantendo padronização visual, reutilização de componentes e integração nativa com Supabase.

O foco permanece na simplicidade operacional, evitando transformar o sistema em um ERP complexo e priorizando rapidez, clareza e facilidade de uso pela equipe administrativa da escola.
