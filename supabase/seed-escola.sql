...
INSERT INTO students (id, name, email, phone, address, active) VALUES
    ('ST-ABCDEF', 'Sofia Almeida',     'sofia.almeida@email.com',     '(21) 97001-0001', 'Rua das Flores, 123', true),
    ('ST-GHIJKL', 'Lucas Mendes',      'lucas.mendes@email.com',      '(21) 97001-0002', 'Av. Atlântica, 456',  true),
    ('ST-MNOPQR', 'Isabella Costa',    'isabella.costa@email.com',    '(21) 97001-0003', 'Rua do Sol, 789',     true),
    ('ST-STUVWX', 'Gabriel Ferreira',  'gabriel.ferreira@email.com',  '(21) 97001-0004', 'Rua Aurora, 321',     true),
    ('ST-YZ1234', 'Valentina Oliveira','valentina.oliveira@email.com','(21) 97001-0005', 'Travessa Azul, 654',  true),
    ('ST-567890', 'Enzo Pereira',      'enzo.pereira@email.com',      '(21) 97001-0006', 'Rua Nova, 987',      true);
